...
INSERT INTO `alumno` VALUES ('1400025G87',NULL,'SSSSSSSSSSSSSSSSSSSSSS',NULL,'ELECTRICIDAD','FISICO-MATEMATICO','Quinto','E','MATUTINO','30DCT0236O','jorge@cbtis66.edu.mx','CODJ721205HVZRMR05',NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `alumno` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `asignalobal`
--

DROP TABLE IF EXISTS `asignalobal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `asignalobal` (
...
--
-- Dumping data for table `asignalobal`
--

LOCK TABLES `asignalobal` WRITE;
/*!40000 ALTER TABLE `asignalobal` DISABLE KEYS */;
/*!40000 ALTER TABLE `asignalobal` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `globales` VALUES (2,'1400025G87','721205','9','1','05/11/2023',0);
...
-- Dump completed on 2023-11-05 19:28:16
