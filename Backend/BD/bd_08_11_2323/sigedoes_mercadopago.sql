...
CREATE TABLE `mercadopago` (
  ...
  `datalleStatus` varchar(45) DEFAULT NULL,
  `description` varchar(45) DEFAULT NULL,
  `monto` int DEFAULT NULL,
  `comisionMercadoPago` decimal(10,0) DEFAULT NULL,
  `total` decimal(10,0) DEFAULT NULL,
  `correo` varchar(45) DEFAULT NULL,
  `urlNotificacion` varchar(45) DEFAULT NULL,
  `fecha_aprobacion` varchar(45) DEFAULT NULL,
  `external_reference` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2023-11-08 23:57:47
