CREATE DATABASE  IF NOT EXISTS `sigese` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sigese`;
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
-- Host: localhost    Database: sigese
-- ------------------------------------------------------
...
INSERT INTO `administrativo` VALUES ('admin','Control Escolar','CBTIS 66','2747431019','Control Escolar','Matutino','cotm@cbtis66.edu.mx','X',NULL);
...
INSERT INTO `alumno` VALUES ('1400025G87','LIZ CASTRO LUNA','CASTRO','LUNA','SSSSSSSSSSSSSSSSSSSSSS','ELECTRICIDAD','FISICO-MATEMATICO','Quinto','E','MATUTINO','07:00 a 15:00 hrs','30DCT0236O','jorge@cbtis66.edu.mx',1,'CODJ721205HVZRMR05',''),('721205','Jorge Cortés Domínguez','CORTES','DOMINGUEZ','16 de Septiembre 1605','Programacion','a','5','G','Matutino','si','30DCT0236O','jorge@cbtis66.edu.mx',1,'CODJ721205HVZRMR05',''),('admin','JORGE CORTES DOMINGUEZ','CORTES','DOMINGUEZ','16 DE SEPTIEMPRE 1605','PROGRAMACION','FISICO-MATEMATICO','Tercer','G','MATUTINO','07:00 a 15:00 hrs','30DCT0236O','jorge@cbtis66.edu.mx',1,'CODJ721205HVZRMR05','');
...
INSERT INTO `docente` VALUES (721205,721205,'MSC SISTEMAS COMPUTACIONALES','2741145286','CODJ721205FC3','X','X','2017-02-01','jorge@cbtis66.edu.mx',NULL);
...
INSERT INTO `usuario` VALUES (1,'admin','admin','1205','CO',600,'JORGE','CORTES','DOMINGUEZ',NULL,1),(2,'1400025G87','1400025G87','12345678','AL',300,'LIZ','CASTRO','LUNA',NULL,1),(3,'721205','721205','1205','DO',700,'JORGE','CORTES','DOMINGUEZ',NULL,1);
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'sigese'
--

--
-- Dumping routines for database 'sigese'
--
...
/*!50001 VIEW `querydocente` AS select `usuario`.`nombre` AS `nombre`,`usuario`.`apellidoP` AS `apellidoP`,`usuario`.`apellidoM` AS `apellidoM`,`docente`.`numControl` AS `numControl`,`docente`.`idUser` AS `idUser`,`docente`.`gradoAcademico` AS `gradoAcademico`,`docente`.`telefono` AS `telefono`,`docente`.`RFC` AS `RFC`,`docente`.`CURP` AS `CURP`,`docente`.`CEDULA` AS `CEDULA`,`docente`.`fechaInicio` AS `fechaInicio`,`docente`.`correo` AS `correo`,`docente`.`foto` AS `foto` from (`usuario` join `docente` on((`usuario`.`numControl` = `docente`.`numControl`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-10-16 14:37:31
